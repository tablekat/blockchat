...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = (function (_super) {
	    ...
	    App.prototype.render = function () {
	        ...
	        // </Router>
	        return (React.createElement(PageContainer_1.default, null));
	    };
	    return App;
	}(React.Component));
	exports.App = App;
	var store = redux_1.createStore(reducers_1.default);
	ReactDOM.render(React.createElement(react_redux_1.Provider, {store: store}, React.createElement(App, null)), document.getElementById("example"));
...
/***/ function(module, exports) {
	...
	"use strict";
	var greeting = function (state, action) {
	    switch (action.type) {
	        case 'ADD_GREETING':
	            return {
	                id: action.id,
	...
	exports.greetings = function (state, action) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = exports.greetings;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PageContainer = (function (_super) {
	    ...
	    PageContainer.prototype.componentDidMount = function () {
	        var _this = this;
	        socket.on('new-message', function (_a) {
	            var msg = _a.msg;
	            _this.onNewMessage(msg);
	        });
	        socket.on('update-messages', function (_a) {
	            var msgs = _a.msgs;
	            _this.setState({
	                messages: msgs,
	            });
	    ...
	    PageContainer.prototype.createMessage = function (msg) {
	        socket.emit('new-message', { msg: msg });
	        this.onNewMessage(msg);
	    };
	    PageContainer.prototype.onNewMessage = function (msg) {
	        this.setState({
	    ...
	    PageContainer.prototype.render = function () {
	        var _this = this;
	        return (React.createElement("div", {style: styles.container}, React.createElement(MessagesContainer_1.MessagesContainer, {messages: this.state.messages}), React.createElement(ControlsComponent_1.ControlsComponent, {createMessage: function (msg) { return _this.createMessage(msg); }})));
	    };
